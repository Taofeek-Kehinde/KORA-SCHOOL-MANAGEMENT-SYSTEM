...
const SubjectModal = ({ subject, schoolId, onClose, onSuccess }) => {
  ...
  useEffect(() => {
    if (subject) {
      setFormData({
        ...
        isElective: subject.is_elective || false
      });
    }
  }, [subject]);
  ...
  const updateMutation = useMutation({
    mutationFn: async (data) => {
      const response = await api.put(`/academic/schools/${schoolId}/subjects/${subject.id}`, data);
      return response.data;
    },
    onSuccess: () => {
